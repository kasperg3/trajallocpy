...
python3.11 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=trajectory_14robots_200capacity_AC300 --n_robots=14 --capacity=200 > ours_14robots_200capacity_AC300.tx &
python3.11 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=trajectory_12robots_200capacity_AC300 --n_robots=12 --capacity=200 > ours_12robots_200capacity_AC300.tx &
python3.11 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=trajectory_10robots_200capacity_AC300 --n_robots=10 --capacity=200 > ours_10robots_200capacity_AC300.tx &
python3.11 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=trajectory_8robots_300capacity_AC300 --n_robots=8 --capacity=300 > ours_8robots_300capacity_AC300.txt &
python3.11 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=trajectory_6robots_400capacity_AC300 --n_robots=6 --capacity=400 > ours_6robots_400capacity_AC300.txt &
python3.11 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=trajectory_4robots_500capacity_AC300 --n_robots=4 --capacity=500 > ours_4robots_500capacity_AC300.txt &
python3.11 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=trajectory_2robots_1000capacity_AC300 --n_robots=2 --capacity=1000 > ours_2robots_1000capacity_AC300.txt &
