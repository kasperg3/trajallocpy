...
# python3 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=point_14robots_200capacity_AC300 --point_estimation=True --n_robots=14 --capacity=200 > logs/point_14robots_200capacity_AC300.txt &
# python3 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=point_12robots_200capacity_AC300 --point_estimation=True --n_robots=12 --capacity=200 > logs/point_12robots_200capacity_AC300.txt &
# python3 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=point_10robots_200capacity_AC300 --point_estimation=True --n_robots=10 --capacity=200 > logs/point_10robots_200capacity_AC300.txt &
# python3 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=point_8robots_300capacity_AC300  --point_estimation=True --n_robots=8 --capacity=300  > logs/point_8robots_300capacity_AC300.txt &
# python3 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=point_6robots_400capacity_AC300  --point_estimation=True --n_robots=6 --capacity=400  > logs/point_6robots_400capacity_AC300.txt &
# python3 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=point_4robots_500capacity_AC300  --point_estimation=True --n_robots=4 --capacity=500  > logs/point_4robots_500capacity_AC300.txt &
# python3 main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=point_2robots_1000capacity_AC300 --point_estimation=True --n_robots=2 --capacity=1200 > logs/point_2robots_1200capacity_AC300.txt &
...
# python3.10 main.py --dataset=AC300  --n_robots=14 --capacity=300  --experiment_name=14robots_300capacity_AC300 > logs/trajectory_14robots_300capacity_AC300.tx &
# python3.10 main.py --dataset=AC300 --n_robots=12 --capacity=300 --experiment_name=12robots_300capacity_AC300 > logs/trajectory_12robots_300capacity_AC300.tx &
# python3.10 main.py --dataset=AC300 --n_robots=10 --capacity=300 --experiment_name=10robots_300capacity_AC300 > logs/trajectory_10robots_300capacity_AC300.tx &
# python3.10 main.py --dataset=AC300 --n_robots=8 --capacity=375  --experiment_name=8robots_375capacity_AC300 > logs/trajectory_8robots_375capacity_AC300.txt &
python3.10 main.py --dataset=AC300 --n_robots=6 --capacity=1500  --experiment_name=6robots_500capacity_AC300 > logs/trajectory_6robots_500capacity_AC300.txt &
python3.10 main.py --dataset=AC300 --n_robots=4 --capacity=1500  --experiment_name=4robots_750capacity_AC300 > logs/trajectory_4robots_750capacity_AC300.txt &
python3.10 main.py --dataset=AC300 --n_robots=2 --capacity=1500 --experiment_name=2robots_1500capacity_AC300 > logs/trajectory_2robots_1500capacity_AC300.txt &
