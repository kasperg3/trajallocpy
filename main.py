...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--point_estimation", type=bool, help="Bool for wether to use point estimation"
    )
    parser.add_argument("--show_plots", type=bool, help="whether to show plots")
    ...
    # python main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=ours_4robots_600capacity_AC300 --n_robots=4 --capacity=600 --point_estimation=False
    # python main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=ours_4robots_600capacity_AC300 --n_robots=4 --capacity=600 --point_estimation=False
    # python main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=ours_2robots_1200capacity_AC300 --n_robots=2 --capacity=1200 --point_estimation=False
    ...
    # python main.py --dataset=AC300 --route_file_name=mem_inf_route_data0 --experiment_name=ours_1robots_infcapacity_AC300 --n_robots=1 --point_estimation=False
